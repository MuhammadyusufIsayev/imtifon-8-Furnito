  ...
  return (
    ...
    >
      <div className="container mx-auto flex flex-col items-center justify-center h-[350px]">
        ...
        <h1 className="text-[48px] font-[500]">Checkout</h1>
        <p className="text-[16px] font-[500] flex items-center">
          <Link href="/cart">Cart</Link>{">"} <span className="font-[300] ml-1"> Checkout</span>
        </p>
      </div>
    </div>
  );
...
export default Section1Checkout;
