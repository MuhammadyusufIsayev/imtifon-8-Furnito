  ...
  return (
    ...
    >
      <div className="container mx-auto flex flex-col items-center justify-center h-[350px]">
        ...
        <h1 className="text-[48px] font-[500]">Product Comparison</h1>
        <p className="text-[16px] font-[500] flex items-center">
          <Link href="/">Home</Link>{">"} <span className="font-[300] ml-1"> Comporision</span>
        </p>
      </div>
    </div>
  );
...
export default Section1Comporison;
